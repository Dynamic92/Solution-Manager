...
class OnboardingManager {
    ...
    private func onboardOrRestoreWithoutSplashScreen() {
        let settingsParameters = SAPcpmsSettingsParameters(backendURL: URL(string: "https://mobile-g9a84e0b47.hana.ondemand.com/")!, applicationID: "com.ferrero.sap.SolutionManager")
        let oAuth2Parameters = OAuth2AuthenticationParameters(authorizationEndpointURL: URL(string: "https://oauthasservices-g9a84e0b47.hana.ondemand.com/oauth2/api/v1/authorize")!, clientID: "3aab6ab2-489b-4eaa-9637-f4e5319d5b97", redirectURL: URL(string: "https://oauthasservices-lca560d580.hana.ondemand.com")!, tokenEndpointURL: URL(string:"https://oauthasservices-g9a84e0b47.hana.ondemand.com/oauth2/api/v1/token")!)
        ...
        context.info[.authenticationURL] = URL(string: "https://mobile-g9a84e0b47.hana.ondemand.com/com.ferrero.sap.SolutionManager")
